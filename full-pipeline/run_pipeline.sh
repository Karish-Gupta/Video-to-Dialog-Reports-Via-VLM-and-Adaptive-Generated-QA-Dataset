...
# PyTorch has CUDA bundled, no need to load system CUDA module
...
# Set LD_LIBRARY_PATH to use system CUDA libraries and PyTorch's bundled libraries
export LD_LIBRARY_PATH=/usr/local/cuda/lib64:$(python -c "import torch; import os; print(os.path.join(os.path.dirname(torch.__file__), 'lib'))"):$LD_LIBRARY_PATH
echo "LD_LIBRARY_PATH set to include CUDA libraries"
